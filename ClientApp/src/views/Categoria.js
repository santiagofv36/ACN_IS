...
const Categoria = () => {
    ...
    const abrirEditarModal = (data) => {
        setError(null); // Agregar esta línea para restablecer el valor de error
        setCategoria(data);
    ...
    const guardarCambios = async () => {
        ...
        if (categorias.some(c => c.descripcion.toLowerCase() === categoria.descripcion.toLowerCase())) {
            setError('La categoría ya está registrada.');
            return;
        }
